...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-105105410-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-105105410-1');
</script>
	...
	<div class="heading-container">
		<header id="masthead" class="site-header clearfix container" role="banner">
			<div class="site-branding container clearfix">
				<h1><a href="<?php bloginfo('url');?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo-purple-v13.svg" class="logo" width="350" height="350" alt="houseyourplants logo"></a></h1>
			</div><!-- .site-branding -->
