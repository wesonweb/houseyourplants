<?php /* Template Name: Find Your Plant Search Page */ ?>
	...
	<?php get_header(); ?>
			...
			<?php
				if(!empty($_POST ['submitted']) == 'Y' ): //checks if hidden input field in plant search form has returned Y
				...
				<?php //Define the loop based on arguments
				...
				<div class="plant-container">
					...
					<?php endwhile;
						...
						<div class="container">
							...
							for.
							<br /> More plants will be added soon.</p>
